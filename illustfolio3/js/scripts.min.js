...
var TumblrPosts=function(a){this.option=$.extend({},this.option),this.config(a),this.$=$(this),this.on(this.EVENT_COMPLETE,$.proxy(this._createTagData,this))};!function(a,b){a.EVENT_COMPLETE="complete",a.EVENT_PROGRESS="progress",a.option={url:"/api/read/json/",restPath:"/api/read/json/",domain:null,maxNum:0},a.$=null,a.offset=0,a.step=50,a.posts=[],a.tags=[],/**
	 ...
	 */
a.config=function(a){return"undefined"==typeof a?this.option:"string"==typeof a?this.option[a]:("[object Object]"===Object.prototype.toString.call(a)&&(b.extend(this.option,a),"domain"in a&&this.config("domain")&&this.config({url:"http://"+this.config("domain")+this.config("restPath")})),this)},/**
...
$(".post.text iframe[src*='youtube.com']").wrap("<div class='video-iframe'></div>"),// fitvid
...
a.infinitescroll({navSelector:".pagenation-index",nextSelector:".pagenation-index .next",itemSelector:".post",animate:!1,loading:{img:"//static.tumblr.com/xlsgtjb/V4Zne2alt/blank.gif",msgText:"\n        <div class='spinner'>\n          <div class='rect1'></div>\n          <div class='rect2'></div>\n          <div class='rect3'></div>\n          <div class='rect4'></div>\n          <div class='rect5'></div>\n        </div>\n      ",finishedMsg:""}},function(b){var c=$(b).css({opacity:0});c.imagesLoaded(function(){a.animate({opacity:1}),a.masonry("appended",c,!0)})}),// 外部サイトにはtarget blankする
